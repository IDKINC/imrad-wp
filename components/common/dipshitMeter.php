...
$evidenceCount = $people_obj->evidenceCount;
?>
...
<?=(!is_null($dipshitScore) ? $people_obj->name . " is " : "We Don't Have")?>
...
switch (true) {
	...
	case is_null($dipshitScore):
        echo "Any Data";
        break;
    case !is_null($dipshitScore) && $dipshitScore == 0:
        echo "NOT a  Dipshit";
        break;
    case $dipshitScore == 1:
        echo "a Very Small Dipshit";
        break;
    case $dipshitScore == 2:
...
<svg version="1.1" id="dipshitMeter" class="<?=(is_null($dipshitScore) ? "no-data" : "")?>" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
...
<g>
	...
	<g fill="#ffffff" class="dipshit__dot <?=($dipshitScore == 3 ? "selected" : "")?>">
		...
		<g fill="#ffffff" class="dipshit__dot <?=($dipshitScore == 0 ? "selected" : "")?>">
...
<?php get_template_part( "components/common/dipshitSubmitBox" ); ?>
